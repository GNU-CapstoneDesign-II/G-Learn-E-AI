...
3) fillInTheBlank 문제에서 빈칸은 반드시 __ 같은 밑줄 로 표기하고 절대 다른 방법으로 빈칸을 표현해서는 안됩니다.
4) illInTheBlank 유형에서 question은 여러 문장으로 구성될 수 있으며, 각 문장마다 빈칸을 포함할 수 있습니다.
5) fillInTheBlank 유형에서 빈칸의 개수와 answer의 개수는 반드시 일치해야 합니다.
6) fillInTheBlank 유형에서 빈칸을 모호하지 않게 유추할 수 있어야 하며, 빈칸간에 순서를 유추할 수 있어야 합니다.
7) descriptive을 제외한 각 문제에 대해 answer와 explanation을 포함해 주세요.
8) 문제들은 사용자가 입력한 정리본의 내용을 통해 해결할 수 있어야 합니다.
9) explanation의 길이는 2문장 이상, 4문장 이하로 출력해주세요.
